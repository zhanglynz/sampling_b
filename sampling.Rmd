...
- **Conditional Poisson sampling:** This design has prescribed **unequal inclusion probabilities** but results in samples with **fixed sample size**; see more details in Till`r knitr::asis_output("\u00E9")` and Wilhelm (2017).
